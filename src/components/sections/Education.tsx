...
export default function EducationSection() {
  ...
  return (
    <section id="education" ref={ref} className="py-16 sm:py-24 bg-white border-y border-slate-100 overflow-hidden">
            ...
            {chronologicalEducation.map((edu, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="w-full max-w-xl pt-18 md:pt-0 pl-0 md:pl-24 flex flex-col items-center md:items-start">
                    {/* Duration Badge */}
                    <span className="inline-flex items-center gap-1.5 text-xs font-semibold sm:font-bold text-cyan-600 bg-cyan-50 px-3 py-1 rounded-full mb-2 sm:mb-3 shadow-sm border border-cyan-100/50">
                      <Calendar className="w-3.5 h-3.5" />
                      {edu.duration}
                    </span>

                    {/* Degree Title */}
                    <h3 className="text-lg md:text-xl md:text-2xl font-black text-gray-900 leading-tight mb-2 hover:text-cyan-600 transition-colors">
                      {edu.degree}
                    </h3>

                    {/* School Name and Hyperlink */}
                    <div className="flex items-center gap-3 mb-2 sm:mb-3 justify-center md:justify-start w-fit px-3 z-10 bg-white">
                      <a
                        href={edu.url}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1.5 text-xs sm:text-sm font-semibold text-gray-600 hover:text-cyan-600 transition-colors group"
                      >
                    ...
                    {/* Description */}
                    <p className="text-gray-500 text-sm md:text-base leading-relaxed mb-2 sm:mb-4 text-center md:text-left">
                      {edu.description}
                    </p>
